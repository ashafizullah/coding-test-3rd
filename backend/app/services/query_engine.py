...
class QueryEngine:
    ...
    def _initialize_llm(self):
        ...
        Supports: groq, openai, ollama, anthropic
        """
        ...
        try:
            ...
            logger.error(f"Failed to import LLM provider {provider}: {e}")
            logger.info("Install missing package: pip install langchain-groq or langchain-anthropic")
            raise
